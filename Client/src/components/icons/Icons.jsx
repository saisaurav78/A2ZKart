  ...
  return (
    ...
    >
      <g fill='#02020b' className='color000000 svgShape' transform='scale(1.875)'>
        ...
        />
        <g className='color000000 svgShape' transform='rotate(3.884 1246.644 76.259) scale(1.0884)'>
          <polygon
            fill='#356cdc'
            fill-rule='evenodd'
        ...
        <g className='color000000 svgShape' transform='translate(-1430.73 1262.04) scale(.7358)'>
          <path
            fill='#d36135'
